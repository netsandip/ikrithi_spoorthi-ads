<div class="row">
    <div class="col-lg-12">
        ...
        <a href="<?php echo base_url() . "client/manage_coordinator/" . $client_id; ?>" class="btn btn-primary pull-right btn-top-right">Create New</a>
    </div><!-- /.col-lg-12 -->
</div><!-- /.row -->
<div class="row">
    <div class="col-md-4">
                        ...
                        <?php foreach ($coordinators as $coordinator) { ?>
                            <tr>
                                ...
                                <td class="text-center">
                                    <a class="btn btn-xs btn-success" href="<?php echo base_url('client/edit_coordinator/' . $client_id . '/' . $coordinator->id); ?>" ><i class="fa fa-edit"></i></a>
                                </td>
                            </tr>
                        <?php } ?>
                    <?php } else { ?>
